...
public struct OctreeNode<T> where T : IOctreeObject
{
    ...
    public OctreeNode(Vector3 center, Vector3 size, int depth, int minDepth)
    {
        _center = center;
        _size = size;
        _depth = depth;
        ...
        _bounds = new Bounds(_center, _size);
        _objects = new List<T>();
        _children = null;
    }
    ...
    private void Split()
    {
        ...
        _children[0] = new OctreeNode<T>(_center + new Vector3(-quarter.x, quarter.y, -quarter.z), half, _depth + 1, _minDepth);
        _children[1] = new OctreeNode<T>(_center + new Vector3(-quarter.x, quarter.y, quarter.z), half, _depth + 1, _minDepth);
        _children[2] = new OctreeNode<T>(_center + new Vector3(-quarter.x, -quarter.y, -quarter.z), half, _depth + 1, _minDepth);
        _children[3] = new OctreeNode<T>(_center + new Vector3(-quarter.x, -quarter.y, quarter.z), half, _depth + 1, _minDepth);
        _children[4] = new OctreeNode<T>(_center + new Vector3(quarter.x, quarter.y, -quarter.z), half, _depth + 1, _minDepth);
        _children[5] = new OctreeNode<T>(_center + new Vector3(quarter.x, quarter.y, quarter.z), half, _depth + 1, _minDepth);
        _children[6] = new OctreeNode<T>(_center + new Vector3(quarter.x, -quarter.y, -quarter.z), half, _depth + 1, _minDepth);
        _children[7] = new OctreeNode<T>(_center + new Vector3(quarter.x, -quarter.y, quarter.z), half, _depth + 1, _minDepth);
