...
public class Octree<T> where T : IOctreeObject
{
    ...
    public Octree(Vector3 center, Vector3 size, int minDepth)
    {
        _center = center;
        _size = size;
        _minDepth = minDepth;

        _root = new OctreeNode<T>(_center, _size, 0, _minDepth);
    }
    ...
    public void DrawBounds()
    {
        ...
        Gizmos.DrawWireSphere(_collidingCenter, _collidingRadius);
